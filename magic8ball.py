...
eight_ball = [ "It is really", "It is my choice so", "Without a question", "Yes, sure",
               "You may count on it", "As I see it, yes", "Most Likely", "Outlook Good",
               "Yes", "Signs point to yes", "Reply hazy, try again", "Try again later",
               "Better not tell you now", "Cannot predict now", "Concentrate and ask again",
               "Don't count on it", "My reply is no", "My sources say no", "Outlook not so good", "Very Doubtful"]

def ques():
    ques = raw_input("You may ask your yes or no question of the Magic 8 Ball!\n")
    print("Thinking...")
